...
class DrawLines():
    ...
    def on_mouse(self, event, x, y, buttons, user_param):
        ...
        # boton esquerdo: debuxamos unha linha
            ...
            cv2.putText(self.image, str(self.cont_linhas), (self.image_coordinates[0][0], self.image_coordinates[0][1]-5),
        ...
        # limpar as linhas
            ...
            self.image = self.without_lines.copy()
            self.cont_linhas = 0
            self.points_coord = []
...
if __name__ == "__main__":
    ...
    print(lines)
    print("Numero de linhas debuxadas: ",len(lines))
